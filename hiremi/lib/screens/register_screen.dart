            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ClipOval(child: Consumer<RegisterProvider>(
                      builder: (context, value, child) {
                    return Container(
                      height: 12,
                      width: 12,
                      color:
                          value.isMaleSelected ? MyColor.green : MyColor.grey,
                    );
                  })),
                  InkWell(
                      onTap: () {
                  ...
                  ClipOval(child: Consumer<RegisterProvider>(
                    ...
                    return Container(
                      ...
                      width: 12,
                      color:
                          value.isFemaleSelected ? MyColor.green : MyColor.grey,
                    );
                  })),
                  InkWell(
                      onTap: () {
                  ...
                  ClipOval(child: Consumer<RegisterProvider>(
                    ...
                    return Container(
                      ...
                      width: 12,
                      color:
                          value.isOtherSelected ? MyColor.green : MyColor.grey,
                    );
                  })),
                ],
              ),
                  ...
                  onPressed: () async {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      Map<String, dynamic> body = {
                        ...
                        "gender": registerProvider.genderSelector,
